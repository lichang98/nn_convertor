...
model_save_path = os.path.join(".", "ann_model_descs/conv_model.h5")
input_shape = (28, 28, 1)
...
def build_model(input_shape: tuple):
    ...
    flatten5 = keras.layers.Flatten()(pool4)
    fc6 = keras.layers.Dense(512, activation="relu", use_bias=False)(flatten5)
    fc7 = keras.layers.Dense(256, activation="relu", use_bias=False)(fc6)
    fc8 = keras.layers.Dense(32, activation="relu", use_bias=False)(fc7)
    fc9 = keras.layers.Dense(10, activation="softmax", use_bias=False)(fc8)

    model = keras.models.Model(inputs=x, outputs=fc9)
